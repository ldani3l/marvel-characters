    ...
    <section class="mt-10">
        <form class="flex flex-col" method="POST" action="{{ route('character.find') }}">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input required placeholder="Nombre de tu persoja favorito" type="text" name="name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-red-600 transition duration-500 px-3 pb-3">
            </div>
